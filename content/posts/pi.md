...
categories: [ "笔记" ]
featuredImage: "https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/pinOut.png"
featuredImagePreview: "https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/pinOut.png"
---
...
{{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/gpio.png" caption="gpio readall 返回信息" >}}
...
{{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/uart0.png" caption="uart0串口信息 GPIO14输出GPIO15输入" >}}
...
{{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/tty.png" caption="ttyAMA1~4都开启了" >}}
...
{{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/tty-pins.png" caption="串口和针脚的对应关系很明显了" >}}
...
{{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/J8-gpio.png" caption="图片更明显" >}}
...
{{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/aurt-test.png" caption="执行结果" >}}
...
2. `sudo nano /etc/systemd/system/dbus-org.bluez.service` 修改蓝牙配置文件
   ...
   {{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/bluez.png" caption="蓝牙配置文件修改后" >}}
...
{{< figure src="https://blog.gruex.info:9004/data/blog-img/minio-blog-pic/pi/rf.png" caption="连接成功" >}}
